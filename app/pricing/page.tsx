...
Are you ready to take your business to the next level with Nadra?
 ...
 <div style={{backgroundColor:'#553448D9'}} className='w-[100%] text-white   flex justify-center items-center h-[10%] text-center'>
      ...
      <strong className='!ml-[5px] text-lg'>{instance==='monthly'? item.price:item.price*12*0.85} {instance==='monthly'?'/ month':"/ year"}</strong>
  </div>

  <div className='w-[100%] !px-[4%] !py-[10%]  flex-col  flex justify-start items-start h-[55%]'>
