 ...
 <div className={styles.rightLink}>
        ...
        >Shop with confidence</h1>
               ...
               text-[7vw]
                ...
                `}>Sell with purpose</h1>
                  <div  className={`w-[100%] md:w-[80%]  lg:w-[40%] sm:leading[10px] md:leading[20px] lg:leading[40px]   ${styles.pitchCover}`}>
                <p className={`${styles.pitchParagraph}   text-[3vw]  lg:text-[2vw]`}>
  ...
  lg:w-[40%]
      ...
      text-[3vw] 
        ...
        w-auto            
         text-[3vw] 
         lg:text-[2vw]
                              ${styles.pitchBtn} ${styles.sellerBtn}`}
       onClick={handlePress}
      >Get Demo</div>
  ...
  flex items-center justify-center flex-col
     ...
     alt='production'
       ...
       <div className={`w-[40%]  aspect-[1.2/1] rounded-[3vw]  ${styles.firstFrame}`}>


<div  className={`${styles.firstImageCover} rounded-[3vw]  `}>
...
<div className={`text-[clamp(0.75rem,1.2vw,1.5rem)]  font-semibold flex justify-center items-center ${styles.detailsText}`}>Clear product details</div>

</div>


<div className={`w-[25%] aspect-[1/1.5] rounded-[3vw]  ${styles.secondFrame}`}>


<div  className={`${styles.secondImageCover} rounded-[3vw] `}>
...
<div className={`w-[clamp(100px,30%,400px)]     ${styles.purchaseFrame}  
      text-[3vw] 
         lg:text-[2vw] rounded-[2vw] `}>

  Where every purchase feels like a connection, and every seller is a sister.
</div>

<div className={`w-[clamp(100px,30%,400px)]     ${styles.guessWorkFrame}  text-[3vw] 
         lg:text-[2vw] rounded-[2vw]`}>
No more guesswork
</div>
