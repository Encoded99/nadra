...
import { PaymentModal,CurrencySymbol,SubType,UnicodeType,CalendlyWidget } from '../reusable-components/special/special'
...
const [isCalendlyShown,setIsCalendlyShown]=useState<boolean>(false)
type FeatureType={
  _id:number,
  text:string
}
  ...
  return (
    <main className={`w-[100%]`}>
...

        {
          isCalendlyShown && (
            <>
            <CalendlyWidget setIsModalShown={setIsCalendlyShown}/>
            </>
          )
        }
     <WhiteHeader/>
