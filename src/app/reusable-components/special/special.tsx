...
<Loader style={{color:"#CD4E5E"}} className="w-24 h-24 animate-spin text-white-700" />
       ...
       <div className={` md:w-[80%] lg:w-[50%]  h-[70%] flex justify-around items-center rounded-2xl ${styles.waitListModal}`}  onClick={handleChildClick}>
...

{
  !congrat && !isError && (
    <>
        ...
        <div className={`w-[50%] h-[100%] relative  ${styles.leftImageContainer}` }>
             <Image
